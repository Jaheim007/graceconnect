...
const STEPS: TourStep[] = [
  ...
  },
  {
    ...
    desc_fr: 'Activez le programme d\'affiliation pour permettre à d\'autres de promouvoir vos produits et gagner des commissions.',
    desc_en: 'Enable the affiliate program to let others promote your products and earn commissions.',
