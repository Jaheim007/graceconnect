...
const CATEGORY_KEYWORDS: Record<string, string[]> = {
  business: ['business', 'entrepreneur', 'marketing', 'vente', 'commerce', 'startup', 'dropshipping', 'freelance', 'e-commerce', 'leadership', 'management', 'copywriting', 'branding', 'seo', 'community', 'stratégie', 'strategy'],
  spirituality: ['prière', 'prayer', 'bible', 'spirituel', 'spiritual', 'église', 'church', 'worship', 'dieu', 'god', 'méditation', 'meditation', 'chrétien', 'christian', 'sermon', 'prophét', 'prophet', 'grâce', 'grace', 'foi', 'faith'],
  ...
  motivation: ['motivation', 'développement personnel', 'personal development', 'coaching', 'mindset', 'succès', 'success', 'inspirant', 'inspiring', 'confiance', 'confidence', 'habitudes', 'habits'],
