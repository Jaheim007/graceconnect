  ...
  return (
    <div className="space-y-8 pt-8">
      <div className="text-center space-y-2">
        <h2 className="text-2xl sm:text-3xl font-extrabold">Fixe ton prix</h2>
        <p className="text-muted-foreground text-sm">
          Gratuit ou payant, tu décides. On ne gagne que quand tu gagnes.
        </p>
      </div>
      ...
      <div className="flex items-center justify-between p-4 rounded-xl border border-border bg-card">
        <div>
          ...
          <p className="text-xs text-muted-foreground">Les lecteurs laissent leur email pour télécharger</p>
        </div>
        <Switch
        ...
        <>
          ...
          <div className="space-y-3">
            ...
            <p className="text-[10px] text-muted-foreground">
              Plus la commission est élevée, plus tes ambassadeurs sont motivés à vendre.
            </p>
          </div>

          {/* Revenue breakdown */}
          <div className="rounded-xl border border-border bg-muted/30 p-4">
            <p className="text-xs font-bold text-muted-foreground uppercase tracking-wider mb-3">Pour chaque vente</p>
            ...
            <p className="text-xs text-muted-foreground text-center mt-3">
              💡 10 ambassadeurs × 5 ventes = <strong className="text-foreground">{(creatorEarns * 50).toLocaleString('fr-FR')} FCFA</strong>
            </p>
          </div>
        </>
      )}
