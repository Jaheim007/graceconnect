...
import { BookOpen, Share2, DollarSign, Sparkles, ArrowRight, Lightbulb, PenTool, GraduationCap, Church, Users, Briefcase } from 'lucide-react';
...
export function ActivationContentHub() {
  ...
  const guides: GuideCard[] = isFr ? [
    ...
    { emoji: '🛒', icon: DollarSign, title: 'Vendre ton contenu existant', desc: 'Tu as déjà un ebook, une formation ? Mets-le en vente en 2 min.', action: 'Publier', route: '/admin/create', color: 'text-orange-500', bg: 'bg-orange-500/10' },
    ...
    { emoji: '🛒', icon: DollarSign, title: 'Sell your existing content', desc: 'Already have an ebook or course? Put it on sale in 2 min.', action: 'Publish', route: '/admin/create', color: 'text-orange-500', bg: 'bg-orange-500/10' },
