...
const TOUR_STEPS: TourStep[] = [
  ...
  },
  {
    ...
    desc_fr: 'Survolez le nom, la description ou la biographie de votre organisation et cliquez pour modifier directement sur la page.',
    desc_en: 'Hover over your organization name, description or biography and click to edit directly on the page.',
  },
  {
    emoji: '📦',
  ...
  {
    emoji: '🔀',
    title_fr: 'Réorganiser les sections',
    title_en: 'Reorder Sections',
    desc_fr: 'Utilisez les flèches ↑↓ dans le panneau pour changer l\'ordre des sections ou les masquer/afficher.',
    desc_en: 'Use the ↑↓ arrows in the panel to reorder sections or show/hide them.',
  },
  {
    emoji: '🔗',
  ...
  },
  {
    ...
    desc_fr: 'Cliquez sur la bannière ou le logo pour les modifier directement. Vous pouvez aussi le faire depuis le panneau admin.',
    desc_en: 'Click on the banner or logo to edit them directly. You can also do this from the admin panel.',
  },
];
