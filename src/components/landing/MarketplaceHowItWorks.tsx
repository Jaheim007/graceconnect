...
export function MarketplaceHowItWorks() {
  ...
  return (
    <section id="how" className="bg-muted/30 border-y border-border/60 scroll-mt-24">
      <div className="container max-w-6xl px-4 sm:px-6 py-16 sm:py-20">
        ...
        <ol className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-5">
          {steps.map((s, i) => (
            <Reveal as="li" key={i} delay={i * 0.08} className="relative rounded-2xl bg-background border border-border p-5 transition-all duration-300 hover:-translate-y-1 hover:shadow-lg hover:border-foreground/20">
