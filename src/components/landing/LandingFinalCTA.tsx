        ...
        <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp} className="relative rounded-3xl overflow-hidden">
          ...
          <div className="relative z-10 p-10 sm:p-14 text-center space-y-6">
            <motion.h2
              ...
              className="text-3xl sm:text-4xl font-extrabold text-primary-foreground"
            >
            ...
            <motion.p
              ...
              className="text-primary-foreground/80 text-base max-w-md mx-auto"
            >
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
              <Button size="lg" className="bg-background text-foreground hover:bg-background/90 border-0 px-8 h-13 text-sm gap-2 group w-full sm:w-auto relative overflow-hidden shadow-lg" onClick={() => navigate('/auth?mode=signup&intent=writer')}>
              ...
              <Button size="lg" className="bg-primary-foreground/20 text-primary-foreground border-2 border-primary-foreground hover:bg-primary-foreground/30 px-8 h-13 text-sm gap-2 w-full sm:w-auto" onClick={() => navigate('/auth?mode=signup&intent=ambassador')}>
                <Share2 className="h-4 w-4" /> 💰 {isFr ? 'Gagner en partageant' : 'Earn by sharing'}
              </Button>
            </div>
            <button
              onClick={() => navigate('/discover')}
              className="text-xs text-primary-foreground/60 hover:text-primary-foreground transition-colors underline underline-offset-4"
            >
