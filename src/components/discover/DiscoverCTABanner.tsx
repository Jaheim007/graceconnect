...
const cards = [
  {
    ...
    descFr: 'Vendez vos ressources numériques, collectez des dons — gratuitement.',
    descEn: 'Sell your digital resources, collect donations — for free.',
    ctaFr: 'Commencer',
    ctaEn: 'Get started',
  ...
  },
  {
    ...
    descFr: 'E-books, formations, audio, vidéos — achetez et soutenez des créateurs.',
    descEn: 'E-books, courses, audio, videos — buy and support creators.',
    ctaFr: 'Découvrir',
    ctaEn: 'Discover',
    path: '#products',
  },
