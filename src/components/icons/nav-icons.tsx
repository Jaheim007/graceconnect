...
/* ───────────── Earn (coin dropping into a cupped palm) ───────── */
/* Legible at 20-24px: a $ coin, a rising arrow, and an open palm. */

export const SvEarn = (p: IconProps) => (
  <Outline {...p}>
    <circle cx="12" cy="7" r="4.1" />
    <path d="M13.3 5.9a1.7 1.7 0 0 0-1.4-.7c-.85 0-1.4.42-1.4 1.02 0 .58.55.92 1.4.98.9.06 1.5.4 1.5 1.02 0 .62-.6 1.04-1.5 1.04a1.8 1.8 0 0 1-1.5-.72" />
    <path d="M12 4.1v.9M12 9.1v.9" />
    <path d="M3.9 15.1c0 3.1 3.6 5 8.1 5s8.1-1.9 8.1-5" />
    <path d="M3.9 15.1h2.6M17.5 15.1h2.6" />
  </Outline>
);
...
export const SvEarnSolid = (p: IconProps) => (
  <Solid {...p}>
    <path
      fillRule="evenodd"
      clipRule="evenodd"
      d="M12 2.9a4.1 4.1 0 1 0 0 8.2 4.1 4.1 0 0 0 0-8.2Zm.7 1.3v.42c.62.15 1.1.5 1.36.93a.7.7 0 0 1-1.2.72c-.16-.26-.47-.42-.9-.42-.55 0-.82.26-.82.5 0 .27.32.44.85.48.92.07 1.86.52 1.86 1.62 0 .74-.53 1.31-1.24 1.53v.4a.7.7 0 0 1-1.4 0v-.41a2.4 2.4 0 0 1-1.32-.9.7.7 0 0 1 1.14-.82c.17.24.5.41.94.41.6 0 .88-.26.88-.5 0-.27-.31-.43-.83-.47C11.05 7.72 10.1 7.28 10.1 6.2c0-.75.53-1.33 1.25-1.55v-.45a.7.7 0 0 1 1.4 0Z"
    />
    <path d="M3.9 14.1a1 1 0 0 1 1 1c0 1 .68 1.96 2.1 2.71 1.4.75 3.2 1.14 5 1.14s3.6-.39 5-1.14c1.42-.75 2.1-1.7 2.1-2.71a1 1 0 0 1 2 0c0 2.02-1.36 3.5-3.16 4.47-1.8.96-4 1.38-5.94 1.38s-4.14-.42-5.94-1.38C4.26 18.6 2.9 17.12 2.9 15.1a1 1 0 0 1 1-1Z" />
  </Solid>
);
