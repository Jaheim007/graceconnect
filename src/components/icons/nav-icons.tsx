...
export const SvHomeSolid = (p: IconProps) => (
  <Solid {...p}>
    <path
      fillRule="evenodd"
      clipRule="evenodd"
      d={`${HOME_SHELL} M9.8 20.8v-4.4a2.2 2.2 0 0 1 4.4 0v4.4Z`}
    />
  </Solid>
);
...
export const SvEarn = (p: IconProps) => (
  <Outline {...p}>
    <circle cx={COIN_C.cx} cy={COIN_C.cy} r={COIN_C.r} />
    <path d="M13.6 5.3a1.8 1.8 0 0 0-1.5-.8c-.9 0-1.5.5-1.5 1.2s.7 1 1.5 1 1.6.3 1.6 1.1-.7 1.3-1.6 1.3a1.9 1.9 0 0 1-1.6-.9" />
    <path d="M2.3 14.9l1.8-1 3.7 6.5-1.8 1a.8.8 0 0 1-1.1-.3L2 16a.8.8 0 0 1 .3-1.1Z" />
    <path d="M7 17.6l-1.7-3 3.4-2a3.4 3.4 0 0 1 2.7-.4l3.3 1a1.7 1.7 0 0 1-.5 3.3l-3-.4" />
    <path d="M8.4 17.9l2.9-.9 4.6 1.3a3 3 0 0 0 2.3-.3c1.3-.7 3-1.9 5-3.5" />
  </Outline>
);
