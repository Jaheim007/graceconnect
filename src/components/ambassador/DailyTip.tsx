...
import { Lightbulb, TrendingUp, Share2, BookOpen, Zap } from 'lucide-react';
...
/**
 * Daily tip for ambassadors — shown in the dashboard.
 */
export function DailyTip() {
  ...
  return (
    ...
    >
      ...
      <div>
        <p className="text-xs font-bold text-accent mb-0.5">💡 Astuce du jour</p>
