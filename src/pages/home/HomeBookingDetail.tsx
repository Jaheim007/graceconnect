...
import { ArrowLeft, Calendar, MapPin, ShieldCheck, MessageCircle, CheckCircle2, XCircle, Loader2, AlertTriangle, Sparkles } from "lucide-react";
...
const STATUS: Record<string, { fr: string; en: string; color: string; icon: any }> = {
  ...
  en_route: { fr: "En route", en: "En route", color: "sky", icon: Sparkles },
  in_progress: { fr: "En cours", en: "In progress", color: "sky", icon: Sparkles },
        ...
        {review && (
          <div className="rounded-2xl border border-border bg-card p-5">
            <div className="text-sm font-bold flex items-center gap-2">
              <Sparkles className="h-4 w-4 text-sky-500" />{t("Ton avis", "Your review")}
