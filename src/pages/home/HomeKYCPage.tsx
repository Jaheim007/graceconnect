  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      <div className="mx-auto max-w-lg px-4 py-10 text-center">
        <div className="mx-auto grid h-14 w-14 place-items-center rounded-2xl bg-sky-500/10 text-sky-600">
          <ShieldCheck className="h-7 w-7" />
        </div>
        <h2 className="mt-4 text-lg font-black">{isFr ? "KYC bientôt disponible" : "KYC coming soon"}</h2>
        <p className="mt-2 text-sm text-muted-foreground">
          {isFr
            ? "La vérification d'identité pour SiteViral Home arrive dans la prochaine phase. En attendant, tu peux finaliser ton profil et tes services."
