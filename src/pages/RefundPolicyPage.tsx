...
export default function RefundPolicyPage() {
  return (
    <LegalPageShell>
      <SEOHead title="Politique de Remboursement — Siteviral" description="Conditions de remboursement sur Siteviral. Produits numériques, dons, délais et procédures." canonicalUrl="https://siteviral.com/refund-policy" />
