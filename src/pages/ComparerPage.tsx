...
const features: Feature[] = [
  ...
  { category: 'Marketing', categoryEn: 'Marketing', name: 'Programme ambassadeur', nameEn: 'Ambassador program', siteviral: 'yes', competitors: { gumroad: 'no', shopify: 'partial', patreon: 'no', teachable: 'partial', flutterwave: 'no', gofundme: 'no' } },
